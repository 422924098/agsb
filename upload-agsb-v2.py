...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "lyb37"         # 用户名
UUID = "240db27e-6ce0-4bd2-8a7a-fe89d1c88c22"                     # UUID，留空则自动生成
PORT = 48888                   # Vmess端口，留空或0则自动生成
DOMAIN = "ll.longyoytianxia6.pp.ua"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiMmMwODFmODcyZDczMWJhMjI4NDZhOWVlMmJhMWVkYjEiLCJ0IjoiYTg1NjYwZjctM2M0ZS00MjUzLTg2NzQtMjFhNzI2MjI1YmNkIiwicyI6Ik1XRTVPRFppTlRndFl6UTFaaTAwTURrM0xUZzNaakV0WmpoallXRmtaVGcyWVRkbSJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
